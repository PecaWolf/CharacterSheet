...
fun BaseStats.World.getLocalizedName() = when (this) {
    BaseStats.World.BRAVE_NEW_WORLD -> R.string.world_brave_new_world
    BaseStats.World.BLACKWOOD_VALE -> R.string.world_blackwood_vale
...
fun BaseStats.Species.getLocalizedName() = when (this) {
    ...
    BaseStats.Species.GNOME -> R.string.species_gnome
